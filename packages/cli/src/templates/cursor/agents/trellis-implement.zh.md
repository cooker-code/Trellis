...
description: Trellis 实现 agent。Trellis Task 实现、implement.jsonl 上下文注入和 Hook 注入测试必须使用此 agent。不要使用 generic/default/generalPurpose agents 执行 Trellis 实现。不允许 git 提交。
