...
| [Task Git Delivery Commands](./commands-task-delivery.md) | Read-only delivery receipts, explicitly authorized local delivery, PR dry-run, and safe worktree/branch cleanup | Done |
---
...
- Editing `task.py delivery-status`, `deliver`, `delivery-cleanup`, `common/delivery.py`, or finish-work delivery routing → [commands-task-delivery.md](./commands-task-delivery.md)
