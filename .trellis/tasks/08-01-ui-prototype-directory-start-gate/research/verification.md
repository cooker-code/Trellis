...
- 文档：`pnpm --dir docs-site lint`，556 个 Markdown/MDX 文件零错误。
- 模板一致性：发布模板与 `.trellis/` dogfood Python twin byte diff 通过；Marketplace native Workflow 与 bundled Workflow byte diff 通过。
